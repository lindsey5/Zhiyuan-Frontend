...
import EditProductThumbnail from "../../components/user/edit-product/EditProductThumbnail";
import EditProductVariant from "../../components/user/edit-product/EditProductVariant";
