    ...
    return (
        <Modal open={open} onClose={close}>
            <Card className="max-h-[80vh] md:max-h-[70vh] overflow-y-auto">
                <h2 className="text-lg font-semibold mb-3">Transfer Logs Details</h2>
                <div className="mb-5 text-sm border border-[var(--border-panel)] p-2 rounded-lg shadow-lg">
                ...
                {stockTransferLog?.items.map(item => (
                        <div
                            ...
                            className="flex flex-col md:flex-row md:items-center gap-3 border-b border-[var(--border-ui)] py-3"
                        >
                            <img
